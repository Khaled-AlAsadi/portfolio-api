...
urlpatterns = [
    path('auth/obtain-token', views.CustomTokenObtainPairView.as_view(),
         name='obtain-token'),
    ...
    path('languages/delete/<str:id>', views.delete_language,
         name='delete-language'),
    path('languages/update/<str:id>', views.update_language,
